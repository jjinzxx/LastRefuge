...
> **대상:** 이 게임을 만든 본인, 또는 코드를 처음 보는 팀원  
> **목적:** "이 코드가 왜 이렇게 생겼는지"를 이해하고 남에게 설명할 수 있게 되는 것  
> **작성 기준:** 언리얼 엔진 5 C++ 프로젝트
...
> 비유: DataAsset = 아이템의 "설계도". 런타임 아이템 = 설계도를 복사한 "실체".
...
*생성일: 2026-05-20 | 프로젝트: Last Refuge | 엔진: Unreal Engine 5*
